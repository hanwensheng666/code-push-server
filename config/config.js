...
config.development = {
  ...
  db: {
    ...
    port: process.env.RDS_PORT || 3366,
    dialect: "mysql",
    logging: false,
  ...
  local: {
    ...
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://127.0.0.1:3000",
  ...
  jwt: {
    ...
    tokenSecret:
      ...
      "2NNdIyyossum2LhtGvRwwRPfp4poy1Cm7IhrQnjXfBJoVPAVWgl04SUarPJ4I15",
  },
  common: {
    /*
